#!/usr/bin/env python3
"""Preview or apply a conservative mechanical rename of an agent-registry fork."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Rename an agent-registry institutional fork.")
