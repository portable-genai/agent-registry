...
TWO_STATE_READS_WITH_A_REASON: dict[str, str] = {
    "PORT": (
        "The uvicorn TCP port grants no capability; a configured empty or invalid value fails "
        "int() at process start. Interface exposure is resolved separately and three-state."
    ),
    "LOG_LEVEL": (
